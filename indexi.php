...
<body>
	...
	<h1 style="text-align: center;color: #596771;">Crawled Data of IIUI University Faculty</h1>
	...
	foreach($html->find("table.userTable") as $e)
	{	 
		 $name = $e->find('tr')[0]->find('td')[1];
		 $desg = $e->find('tr')[1]->find('td')[0];
		 $name1 = $name->plaintext; //name
		 $desg1 = $desg->plaintext; //name
		 array_push($arr1,$name1);	
		 array_push($arr2,$desg1);	
	}
